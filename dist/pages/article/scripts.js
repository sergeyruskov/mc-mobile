...
$.fn.sideMenu = function () {
	var logicShowMenu = arguments.length <= 0 || arguments[0] === undefined ? function () {} : arguments[0];
	var logicHideMenu = arguments.length <= 1 || arguments[1] === undefined ? function () {} : arguments[1];

	var self = $(this);

	"use strict";
	//Создаем бг
	var sideMenuBg = document.createElement("div");

	document.getElementsByTagName("body")[0].appendChild(sideMenuBg);
	...
	self[0].addEventListener("click", function () {
		"use strict";
...
//Появляющееся слева меню
var navMenuCollapse = document.getElementById("nav-menu-collapse");

$("#navbar-burger").sideMenu(function () {
	"use strict"
...
//todo для работы надо подключить
//bower/jquery-ui/ui/core.js
//bower/jquery-ui/ui/widget.js
//bower/jquery-ui/ui/accordion.js
$("#announcement-list").accordion({
	header: ".js-toggle-announcement-list",
	collapsible: true,
	heightStyle: "content",
	active: false
});
